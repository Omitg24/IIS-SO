...
//V2-EX6d-END
//V4-EX6a-BEGIN
int OperatingSystem_GetBestFittingPartition(int);
int OperatingSystem_GetBiggestPartitionSize();
//V4-EX6a-END
//V4-EX8-BEGIN
...
int OperatingSystem_ObtainMainMemory(int processSize, int PID) {
	...
	bestFit = OperatingSystem_GetBestFittingPartition(processSize);	
	return bestFit; 	
}
//V4-EX6a-END
...
int OperatingSystem_GetBestFittingPartition(int processSize){
